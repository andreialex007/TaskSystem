            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        invoice element category <span  v-show="!!model.id" class="badge badge-danger">#{{ model.id }}</span></h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                <label>Name</label>
                                <input type="text" class="form-control" v-model="model.name" placeholder="Name (required)" value="">
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ok() {
                let component = this;
				this.$http.post(`/invoicesettings/SaveInvoiceElementCategory`,
                    this.model)
                    .then((x) => {
