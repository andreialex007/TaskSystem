<template>
	<main-layout>
		<div class="col-lg-12">
			...
			<h4>Common Items</h4>
			<span class="btn btn-success pull-right btn-xs">
					...
					<table class="table table-bordered table-striped table-sm">
						...
						<tbody>
							<tr v-for="item in commonItems">
								...
								<th>{{ item.category }}</th>
								<th>
									<a title="edit" v-on:click="editElement(item.id)" class="edit btn btn-primary btn-xs" href="javascript:;">
			...
			<h4>Categories</h4>
			<span class="btn btn-success pull-right btn-xss">
				<i class="fa fa-plus"></i>
				Add category
			</span>
