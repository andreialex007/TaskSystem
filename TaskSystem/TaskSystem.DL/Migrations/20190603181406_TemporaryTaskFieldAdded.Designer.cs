...
namespace TaskSystem.DL.Migrations
{
    ...
    [Migration("20190603181406_TemporaryTaskFieldAdded")]
    partial class TemporaryTaskFieldAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskSystem.DL.Entities.Tasks.WorkTask", b =>
                {
                    ...
                    b.Property<bool>("IsTemporaryTask");
            ...
            modelBuilder.Entity("TaskSystem.DL.Entities.Invoices.Invoice", b =>
                {
                    b.HasOne("TaskSystem.DL.Entities.Customers.Customer")
                        .WithMany("Invoices")
                        .HasForeignKey("CustomerId");
